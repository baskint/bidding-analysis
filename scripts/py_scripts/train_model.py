...
class BidOptimizer:
    ...
    def generate_synthetic_data(self, n_samples: int = 5000) -> pd.DataFrame:
        ...
        data = {
            ...
            "engagement_score": np.random.beta(2, 5, n_samples),  # Skewed distribution
    ...
    def engineer_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        df["floor_price_ratio"] = df["floor_price"] / (df["historical_avg_bid"] + 0.01)
        ...
        df["historical_avg_bid"] = df["historical_avg_bid"].fillna(df["floor_price"])
    ...
    def export_to_onnx(self, output_path: str):
        ...
        os.makedirs(
            os.path.dirname(output_path) if os.path.dirname(output_path) else "models",
            exist_ok=True,
        )
        ...
        try:
            ...
            cursor.execute(
                ...
                (
                    ...
                    float(metrics["train_rmse"]),  # Convert np.float64 to Python float
